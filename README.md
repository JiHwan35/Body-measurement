...
```
체형 분류의 기준들인 사용자의 몸통 둘레 , 어깨 너비 , 팔 길이 , 머리 둘레 , 엉덩이 길이 , 다리 길이 모두 구현한 어플리케이션을 통해 도출 해낼 수 있음  
![image](https://user-images.githubusercontent.com/93183216/212849539-dd73dee6-c636-4604-90c2-1c5a47beb69f.png)
